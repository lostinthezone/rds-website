...
<template>
  <div>
    <h3 class="text-3xl font-bold">Privacy Policy</h3>
    <p>
      This privacy policy applies to the Feed Things app (hereby referred to as "Application") for mobile devices that 
      was created by Really Digital Stuff (hereby referred to as "Service Provider") as a Free service. This service is 
      intended for use "AS IS".
    </p>
    <h3 class="text-2xl mt-2">Information Collection and Use</h3>
    ...
    <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain 
      personally identifiable information. The information that the Service Provider request will be retained by them and 
      used as described in this privacy policy.</p>
    
    <h3 class="text-2xl mt-2">Third Party Access</h3>
    ...
    <h3 class="text-2xl mt-2">Opt-Out Rights</h3>
    <p>You can stop all collection of information by the Application easily by uninstalling it. You may use the standard 
      uninstall processes as may be available as part of your mobile device or via the mobile application marketplace or network.</p>

    <h3 class="text-2xl mt-2">Data Retention Policy</h3>
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable 
      ...
      contact them at reallydigitalstuff@gmail.com and they will respond in a reasonable time.</p>

    <h3 class="text-2xl mt-2">Children</h3>
    <p>
    ...
    <p>
      ...
      that a child under 13 has provided personal information, the Service Provider will immediately delete this from their 
      servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, 
      please contact the Service Provider (reallydigitalstuff@gmail.com) so that they will be able to take the necessary actions.      
    </p>
    
    <h3 class="text-2xl mt-2">Security</h3>
    <p>
    ...
    <h3 class="text-2xl mt-2">Changes</h3>
    <p>
    ...
    <h3 class="text-2xl mt-2">Your Consent</h3>
    <p>
    ...
    <h3 class="text-2xl mt-2">Contact Us</h3>
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, 
      please contact the Service Provider via email at reallydigitalstuff@gmail.com.</p>
